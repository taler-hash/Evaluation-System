  ...
  <div 
  x-cloak
  x-show="modalType === 'addCoordinatorModal'" x-transition:enter="transition duration-200 transform origin-center"
  ...
  x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 delay-100" tabindex="-1" aria-hidden="true" class=" bg-gray-400/50  flex justify-center fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-full max-h-full">
      <div class="relative w-[30rem] h-full">
          <!-- Modal content -->
          <div 
            x-show="modalType === 'addCoordinatorModal'" x-transition:enter="transition delay-100 duration-200 transform origin-center"
            ...
            class="relative bg-white rounded-lg shadow">
              ...
              <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b ">
                  <button id="SubmitAddCoordinator">Submit</button>
              </div>
          </div>
      </div>
  </div>
