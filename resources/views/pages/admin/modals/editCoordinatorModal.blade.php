  ...
  <div 
  x-cloak
  x-show="modalType === 'editCoordinatorModal'" x-transition:enter="transition duration-200 transform origin-center"
  ...
  x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 delay-100" tabindex="-1" aria-hidden="true" class=" bg-gray-400/50  flex justify-center fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-full max-h-full">
      <div class="relative w-[30rem] h-full">
          <!-- Modal content -->
          <div 
            x-show="modalType === 'editCoordinatorModal'" x-transition:enter="transition delay-100 duration-200 transform origin-center"
            ...
            class="relative bg-white rounded-lg shadow">
              ...
              <div class="p-6">
                ...
                <div class="space-y-2 mb-2">
                    ...
                    <select x-model="input.course_handled" class="bg-gray-50 border uppercase    border-gray-300 rounded-lg font-semibold focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <template x-for="error in errors.course_handled" class="w-fit">
                        <span x-text="error" class="text-xs text-rose-600 w-fit"></span><br>
                    </template>
                </div>
                <div class="space-y-2 mb-2">
              ...
              <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b ">
                  <button id="SubmitUpdateCoordinator">Submit</button>
              </div>
          </div>
      </div>
  </div>
