        ...
        <div x-data="adminData"  class="w-full h-full">
            <div class="flex items-center justify-between pb-2 ">
                ...
                <div class="relative">
                    ...
                    <input x-model="searchString" x-on:input.debounce.500ms="handleSearch" type="text" id="table-search-users" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search Bar">
                </div>
            </div>
